...
interface ModalProps {
    title: string;
    onClose: () => void;    // se llama DESPUÉS del fade-out
    images?: string[];      // máx 2 URLs
}
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* dos columnas: texto + fotos (columna única en móvil) */}
                <div className="grid gap-6 md:grid-cols-2">
                    {/* Columna texto (centrado en móvil) */}
